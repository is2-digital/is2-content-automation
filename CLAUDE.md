...
PostgreSQL database `n8n_custom_data` with 7 tables: `curated_articles`, `summarization_user_feedback`, `newsletter_themes`, `newsletter_themes_user_feedback`, `markdowngenerator_user_feedback`, `htmlgenerator_user_feedback`, `newsletter_email_subject_feedback`. Schema details in PRD Section 2.2.
