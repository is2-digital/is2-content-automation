...
This PRD captures every functional detail needed to rebuild IS2-News as a standalone Python application (to be called is2-content-automation or ica for short) that replicates the full behavior of the n8n system.
